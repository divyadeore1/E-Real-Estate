...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <head>
        ...
        <title>Pune Real Estate - Pages</title>
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>Pages</strong></h1>
                                    <ul class="controls">
                                        <li class="dropdown">
                                ...
                                <div class="tile-body">
								 <div class="row page_block">
									 ...
									 <div class="col-md-1">
									<button class="btn btn-xs btn-success"><a href="edit_page.php"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></button>
								     </div>
								 </div> 

                                <div class="row page_block">
                                     <div class="col-md-11">
                                        <i class="fa fa-file"> </i> North Properties
									 </div>	
									 <div class="col-md-1">
									<button class="btn btn-xs btn-success"><a href="edit_page.php"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></button>
								     </div>
                                 ...
                                 <div class="row page_block">
                                     <div class="col-md-11">
                                        <i class="fa fa-file"> </i> South Properties
									 </div>	
									 <div class="col-md-1">
									<button class="btn btn-xs btn-success"><a href="edit_page.php"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></button>
								     </div>
								 ...
								 <div class="row page_block">
                                     <div class="col-md-11">
                                        <i class="fa fa-file"> </i> East Properties
									 </div>	
									 <div class="col-md-1">
									<button class="btn btn-xs btn-success"><a href="edit_page.php"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></button>
								     </div>
								 ...
								 <div class="row page_block">
                                     <div class="col-md-11">
                                        <i class="fa fa-file"></i> West Properties
									 </div>	
									 <div class="col-md-1">
									<button class="btn btn-xs btn-success"><a href="edit_page.php"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></button>
								     </div>
